...
class VortexRingC(Component):
    ...
    def __init__(self, Ns):
        super(VortexRingC, self).__init__()
        ...
        # inputs
        self.add('b',        Int(iotype='in', desc='number of blades'))
        self.add('Ns',       Int(iotype='in', desc='number of elements'))
        self.add('yN',       Array(iotype='in', desc='node locations'))
        self.add('rho',      Float(iotype='in', desc='air density'))
        self.add('vc',       Float(iotype='in', desc='vertical velocity'))
        self.add('Omega',    Float(iotype='in', desc='rotor angular velocity'))
        self.add('h',        Float(iotype='in', desc='height of rotor'))
        self.add('dT',       Array(iotype='in', desc='thrust'))
        self.add('q',        Array(iotype='in', desc='deformation'))
        self.add('anhedral', Float(iotype='in'))

        # outputs
        self.add('vi',       Array(iotype='out', desc='induced velocity'))
        self.add('Gamma',    Array(iotype='out', desc='vortex strength'))
        self.add('z',        Array(iotype='out', desc=''))
        self.add('r',        Array(iotype='out', desc=''))
        self.add('vz',       Array(iotype='out', desc=''))
        self.add('vr',       Array(iotype='out', desc=''))
